import { NumberCounter, NumberSorter } from "./model";

export function sortBuilder(threads = 4, ascending = true, counter: NumberCounter): NumberSorter {
    return array => new Promise<number[]>(resolve => {
